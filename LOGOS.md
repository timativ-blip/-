# Логотипы партий (`app/static/logos/`)

Иконки над столбцами диаграммы «Ответы по партиям». Товарные знаки принадлежат соответствующим партиям; используются только для подписи данных на внутреннем дашборде.
